                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          width: double.infinity,
                          child: TextFormField(
                            controller: _model.goalsTextController,
                            focusNode: _model.goalsFocusNode,
                            onChanged: (_) => EasyDebounce.debounce(
                              '_model.goalsTextController',
                              Duration(milliseconds: 2000),
                              () => safeSetState(() {}),
                            ),
                            autofocus: false,
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsetsDirectional.fromSTEB(
                                  24.0, 26.0, 24.0, 26.0),
                              suffixIcon:
                                  _model.goalsTextController!.text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            _model.goalsTextController?.clear();
                                            safeSetState(() {});
                                          },
                                          child: Icon(
                                            Icons.clear,
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            enableInteractiveSelection: true,
                            validator: _model.goalsTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                        FFButtonWidget(
