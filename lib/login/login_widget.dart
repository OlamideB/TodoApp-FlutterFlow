...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signupConfirmPassworrdTextController ??= TextEditingController();
    _model.signupConfirmPassworrdFocusNode ??= FocusNode();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signupConfirmPassworrdTextController,
                                          focusNode: _model
                                              .signupConfirmPassworrdFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.done,
                                          obscureText: !_model
                                              .signupConfirmPassworrdVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle: FlutterFlowTheme.of(
                                                    context)
                                            ...
                                            suffixIcon: InkWell(
                                              ...
                                              focusNode: FocusNode(
                                                  skipTraversal: true),
                                              child: Icon(
                                                _model.signupConfirmPassworrdVisibility
                                                    ? Icons.visibility_outlined
                                                    : Icons
                                                        .visibility_off_outlined,
                                                size: 24.0,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signupPasswordTextController.text !=
                                  _model.signupConfirmPassworrdTextController
                                      .text) {
